// Contact.jsx
// Página de contacto — muestra redes sociales y datos de contacto.
// Soporta cambio de idioma ES/EN mediante el evento "langChange".

import { useState, useEffect } from 'react';

// Traducciones de los textos de la sección
const TEXT = {
  es: {
    title:         '¡Trabajemos Juntos!',
    subtitle:      '¿Tienes un proyecto en mente? ¿Necesitas ayuda con desarrollo web?',
    body:          'Estoy siempre abierto a nuevas oportunidades y colaboraciones. No dudes en contactarme a través de cualquiera de mis redes sociales.',
    infoTitle:     'Información de Contacto',
    email:         'Email',
    location:      'Ubicación',
    locationVal:   'Tijuana, México. Con disponibilidad para trabajo remoto.',
    availability:  'Disponibilidad',
    availVal:      'Disponible para proyectos',
    ctaBtn:        'Enviar un correo',
  },
  en: {
    title:         "Let's Work Together!",
    subtitle:      'Have a project in mind? Need help with web development?',
    body:          "I'm always open to new opportunities and collaborations. Feel free to reach out through any of my social networks.",
    infoTitle:     'Contact Information',
    email:         'Email',
    location:      'Location',
    locationVal:   'Tijuana, Mexico. Available for remote work.',
    availability:  'Availability',
    availVal:      'Available for projects',
    ctaBtn:        'Send an email',
  },
};

// Redes sociales — iconos SVG inline para no depender de librerías externas
const socialLinks = [
  {
    name: 'GitHub',
...
export default function Contact() {
  ...
  // Rastreamos qué cards ya terminaron su animación de entrada
  ...
  return (
    <section className="min-h-screen py-20 px-6 relative flex items-center justify-center">
      ...
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-accent/10 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
          ...
          <div className="space-y-3 text-white/70">
            ...
            <p className="flex items-center justify-center gap-2">
              <span className="font-semibold text-white">{t.availability}:</span>
              <span className="text-green-400">{t.availVal}</span>
            </p>
          </div>
        </div>
